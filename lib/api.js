...
export const api = {
  ...
  user: {
    ...
    getPublicProfile: (username) => api.get(`/user/public/${username}`),
  },
  ...
  elearning: {
    ...
    createQuiz: (moduleId, quizData) => api.post(`/elearning/modules/${moduleId}/quizzes`, quizData),
    deleteQuiz: (quizId) => api.delete(`/elearning/quizzes/${quizId}`),
  },
