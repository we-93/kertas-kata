  ...
  return (
    <aside className={`sidebar-left ${isOpen ? 'open' : ''}`} id="sidebarLeft">
      ...
      <nav className="sidebar-nav" aria-label="Navigasi Utama">
        <span className="nav-section-label">Aktivitas Utama</span>
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge && (
                <span className={`nav-badge ${item.badgeAccent ? 'badge-accent' : ''}`}>
                  {item.badge}
                </span>
              )}
            </Link>
        ...
        <span className="nav-section-label" style={{ marginTop: '0.5rem' }}>Eksplorasi & Layanan</span>
